<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link @if(isset($is_dashboard_active))active @endif " href="{{route('workspace.index')}}">
        ...
        <li class="nav-item">
          <a class="nav-link @if(isset($is_items_active))active @endif " href="{{route('workspace_items.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('workspace_items.index')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
